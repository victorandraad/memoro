...
FATOS = [
    ...
    ("estudo/plano-do-semestre", "Temas do semestre e a ordem de ataque.", ["rotina"], []),
    ...
    ("hobby/violao/exercicios-de-dedilhado", "Quatro padroes de mao direita pra aquecer.", ["hobby/violao/afinacao"], ["estudo/rotina"]),
